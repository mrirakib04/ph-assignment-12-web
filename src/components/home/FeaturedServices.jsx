    ...
    <div className="bg-[#0f172a] py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-6">
          ...
          <Link href="/services">
            <button className="bg-slate-800 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300">
              View All Services
            </button>
          </Link>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center pt-5 border-t border-slate-800">
                  ...
                  <Link href={`/services/${service._id}`}>
                    <button className="flex items-center gap-2 bg-slate-800 hover:bg-blue-600 text-white font-semibold text-sm py-2.5 px-5 rounded-xl transition-all duration-300">
